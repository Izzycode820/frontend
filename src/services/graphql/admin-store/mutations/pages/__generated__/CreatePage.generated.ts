...
export type CreatePageMutation = { __typename?: 'Mutation', pageCreate: { __typename?: 'PageCreate', success: boolean | null, error: string | null, page: { __typename?: 'PageType', id: string, title: string, handle: string, createdAt: string } | null } | null };
