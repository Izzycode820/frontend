...
export type ThemeCustomizationQuery = { __typename?: 'Query', themeCustomization: { __typename?: 'ThemeCustomizationType', id: string, themeName: string, themeSlug: string | null, isActive: boolean, puckConfig: any | null, puckData: any | null, template: { __typename?: 'ThemeDetailsType', id: string, name: string, slug: string } } | null };
