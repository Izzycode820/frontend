...
export { TokenRefreshCoordinator } from './TokenRefreshCoordinator'
...
import { TokenRefreshCoordinator } from './TokenRefreshCoordinator'
...
export class ServiceManager {
  ...
  static cleanup(): void {
    ...
    TokenRefreshCoordinator.reset() // Reset coordinator for fresh login
  }
  ...
  static isInitialized(): boolean {
    return !!TokenManager.getAccessToken() && TokenRefreshCoordinator.isInitializationComplete()
  }
