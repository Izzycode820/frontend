      ...
      <div className="flex-1 flex flex-col min-h-screen pt-16">
        <div className="flex-1 p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-white dark:bg-stone-800 rounded-lg border border-gray-200 dark:border-gray-700 p-12 text-center">
            <div className="w-16 h-16 mx-auto mb-6 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md mx-auto">
              This is where you'll configure your store settings, payment methods, 
              shipping options, and subscription management. Settings panel coming soon.
            </p>
