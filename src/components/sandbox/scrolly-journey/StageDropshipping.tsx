...
const STEPS = [
    ...
    "Import Products: One-click import to your Huzilerz store.",
    "Set Pricing: Add your margin and automate updates.",
    "Start Selling: Drive traffic and let suppliers handle shipping.",
];
...
export default function StageDropshipping() {
    return (
        // BG Color matches the image background to blend effortlessly
