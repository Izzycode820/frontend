...
const STEPS = [
    ...
    "Select Business Model: POD, dropshipping, or inventory.",
...
export default function SectionFashion() {
    return (
        <section className="relative w-full min-h-screen flex items-center justify-center p-6 md:p-20 bg-[#ffe4e9] dark:bg-zinc-950 overflow-hidden">
            ...
            <div className="absolute top-10 left-6 md:top-12 md:left-12 z-20 w-full max-w-full pointer-events-none">
                <h2 className="text-3xl md:text-5xl lg:text-7xl font-thin tracking-tight text-black dark:text-white leading-none whitespace-nowrap">
