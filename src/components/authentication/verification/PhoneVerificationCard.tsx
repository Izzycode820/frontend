...
// Hooks
import { usePhone } from '@/hooks/authentication/usePhone'

// Utils
import { PhoneValidationUtils } from '@/services/authentication/phone'
...
export function PhoneVerificationCard({
    ...
    const maskedPhone = PhoneValidationUtils.maskPhone(phoneNumber)
