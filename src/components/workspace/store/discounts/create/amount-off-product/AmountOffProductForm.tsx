...
interface AmountOffProductFormProps {
  ...
  initialData?: Partial<AmountOffProductFormData>;
  /** Whether we're editing an existing discount */
  isEditing?: boolean;
  /** Pre-loaded products for display (when editing) */
  initialProducts?: any[];
  /** Pre-loaded collections for display (when editing) */
  initialCollections?: any[];
}

export function AmountOffProductForm({
  onSubmit,
  onDiscard,
  isLoading,
  initialData,
  ...
  const [formData, setFormData] = useState<AmountOffProductFormData>(() => ({
    ...
    discountValueType: initialData?.discountValueType || Types.WorkspaceStoreDiscountDiscountValueTypeChoices.Percentage,
    value: initialData?.value,
    appliesToAllProducts: initialData?.appliesToAllProducts ?? false,
  ...
  const [selectedCollections, setSelectedCollections] = useState<any[]>(initialCollections);
