        ...
        <div className="flex flex-col gap-4 pb-32">
                            ...
                            <div className="flex-1 overflow-y-auto p-6 pt-2 space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val) => onCategoryFilterChange?.(val === 'all' ? '' : val)}
                                    >
                                        <SelectTrigger className="h-12">
                ...
                <div className="flex gap-2 flex-wrap px-1">
                    {statusFilter && (
                        <div className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                            Status: {PRODUCT_STATUS_OPTIONS.find(o => o.value === statusFilter)?.label || statusFilter}
                            <X className="h-3 w-3 cursor-pointer" onClick={() => onStatusFilterChange?.('')} />
                        </div>
                    )}
                    {categoryFilter && (
                        <div className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                            Category: {categories.find(o => o.value === categoryFilter)?.label || categoryFilter}
            ...
            {isLoading && products.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center h-[60vh]">
                    ...
                    <p className="text-zinc-500 dark:text-zinc-400 font-medium text-lg">No products found</p>
