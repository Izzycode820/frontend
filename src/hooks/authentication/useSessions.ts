...
export function useSessions(): UseSessionsReturn {
  ...
  const setActiveSessions = useSessionsStore(state => state.setActiveSessions)
  const setCurrentSession = useSessionsStore(state => state.setCurrentSession)
  const removeSession = useSessionsStore(state => state.removeSession)
  const setTerminatingSession = useSessionsStore(state => state.setTerminatingSession)
  const setLoading = useSessionsStore(state => state.setLoading)
  const setTerminating = useSessionsStore(state => state.setTerminating)
  const setError = useSessionsStore(state => state.setError)
  const clearError = useSessionsStore(state => state.clearError)
  const markRefreshed = useSessionsStore(state => state.markRefreshed)
  const getSessionById = useSessionsStore(state => state.getSessionById)
  const isCurrentSession = useSessionsStore(state => state.isCurrentSession)
  const getSessionsFromLocation = useSessionsStore(state => state.getSessionsFromLocation)
