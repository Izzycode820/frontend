...
export function useEmail(): UseEmailReturn {
  ...
  const setVerificationRequestSuccess = useEmailStore((state: any) => state.setVerificationRequestSuccess)
  const setVerificationConfirmSuccess = useEmailStore((state: any) => state.setVerificationConfirmSuccess)
  const setPasswordResetRequestSuccess = useEmailStore((state: any) => state.setPasswordResetRequestSuccess)
  const setPasswordResetConfirmSuccess = useEmailStore((state: any) => state.setPasswordResetConfirmSuccess)
  const setEmailChangeRequestSuccess = useEmailStore((state: any) => state.setEmailChangeRequestSuccess)
  const setEmailChangeConfirmSuccess = useEmailStore((state: any) => state.setEmailChangeConfirmSuccess)
  const setVerificationStatus = useEmailStore((state: any) => state.setVerificationStatus)

  // UI State actions
  const setLoading = useEmailStore((state: any) => state.setLoading)
  const setError = useEmailStore((state: any) => state.setError)
  const clearError = useEmailStore((state: any) => state.clearError)
  const resetVerificationFlow = useEmailStore((state: any) => state.resetVerificationFlow)
  const resetPasswordResetFlow = useEmailStore((state: any) => state.resetPasswordResetFlow)
  const resetEmailChangeFlow = useEmailStore((state: any) => state.resetEmailChangeFlow)
