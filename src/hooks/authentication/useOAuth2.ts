...
export function useOAuth2(): UseOAuth2Return {
  ...
  const setAvailableProviders = useOAuth2Store((state: any) => state.setAvailableProviders)
  const setCurrentProvider = useOAuth2Store((state: any) => state.setCurrentProvider)
  const setAuthorizationFlow = useOAuth2Store((state: any) => state.setAuthorizationFlow)
  const setIsInitiating = useOAuth2Store((state: any) => state.setIsInitiating)
  const setIsAuthenticating = useOAuth2Store((state: any) => state.setIsAuthenticating)
  const setIsLinking = useOAuth2Store((state: any) => state.setIsLinking)
  const setIsUnlinking = useOAuth2Store((state: any) => state.setIsUnlinking)
  const setIsRefreshing = useOAuth2Store((state: any) => state.setIsRefreshing)
  const setAuthenticationResult = useOAuth2Store((state: any) => state.setAuthenticationResult)
  const setLinkingResult = useOAuth2Store((state: any) => state.setLinkingResult)
  const setLoading = useOAuth2Store((state: any) => state.setLoading)
  const setError = useOAuth2Store((state: any) => state.setError)
  const clearError = useOAuth2Store((state: any) => state.clearError)
  const startFlow = useOAuth2Store((state: any) => state.startFlow)
  const completeFlow = useOAuth2Store((state: any) => state.completeFlow)
  const cancelFlow = useOAuth2Store((state: any) => state.cancelFlow)
  const clearFlowData = useOAuth2Store((state: any) => state.clearFlowData)
  const getProviderByName = useOAuth2Store((state: any) => state.getProviderByName)
  const isProviderAvailable = useOAuth2Store((state: any) => state.isProviderAvailable)
  const hasValidState = useOAuth2Store((state: any) => state.hasValidState)
  const isFlowExpired = useOAuth2Store((state: any) => state.isFlowExpired)
  const getTimeRemaining = useOAuth2Store((state: any) => state.getTimeRemaining)
  const canInitiateFlow = useOAuth2Store((state: any) => state.canInitiateFlow)
  const getProviderDisplayInfo = useOAuth2Store((state: any) => state.getProviderDisplayInfo)
