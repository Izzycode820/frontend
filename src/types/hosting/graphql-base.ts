...
export interface SeoSettingsType {
  ...
  /** Favicon URL for browser tab icon */
...
/**
 * Google Search Console verification mutation response
 */
export interface UpdateGoogleVerificationMutation {
  __typename?: 'UpdateGoogleVerificationMutation';
  error?: string | null;
  message?: string | null;
