...
export type NotificationSettingsType = Node & {
  ...
  id: Scalars['ID']['output'];
  inAppSoundEnabled?: Maybe<Scalars['Boolean']['output']>;
  inAppBrowserNotifications?: Maybe<Scalars['Boolean']['output']>;
  quietHoursEnabled?: Maybe<Scalars['Boolean']['output']>;
  quietHoursStart?: Maybe<Scalars['String']['output']>;
  quietHoursEnd?: Maybe<Scalars['String']['output']>;
  inAppEvents?: Maybe<Scalars['JSONString']['output']>;
  notificationEvents?: Maybe<Scalars['JSONString']['output']>;
};

export type UpdateNotificationSettingsInput = {
  inAppSoundEnabled?: InputMaybe<Scalars['Boolean']['input']>;
  inAppBrowserNotifications?: InputMaybe<Scalars['Boolean']['input']>;
  ...
  inAppEvents?: InputMaybe<Scalars['JSONString']['input']>;
};

export type UpdateNotificationSettingsPayload = {
  __typename?: 'UpdateNotificationSettings';
  success?: Maybe<Scalars['Boolean']['output']>;
  settings?: Maybe<NotificationSettingsType>;
};

// Extending Query interface
export interface Query {
  workspaceNotificationSettings?: Maybe<NotificationSettingsType>;
}

export interface QueryWorkspaceNotificationSettingsArgs {
  workspaceId: Scalars['ID']['input'];
}

// Extending Mutation interface
export interface Mutation {
