...
export const STORE_ROUTES = {
  ...
  CHANNELS: {
    ...
    WHATSAPP: (workspaceId: string) => `/workspace/${workspaceId}/store/whatsapp`,
    WHATSAPP_INBOX: (workspaceId: string) => `/workspace/${workspaceId}/store/whatsapp/inbox`,
    WHATSAPP_SETTINGS: (workspaceId: string) => `/workspace/${workspaceId}/store/whatsapp/settings`,
  ...
  // Settings
  SETTINGS: {
    GENERAL: (workspaceId: string) => `/workspace/${workspaceId}/store/settings/general`,
